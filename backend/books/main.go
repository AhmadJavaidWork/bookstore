...
func main() {
	...
	mux.HandleFunc("GET /", cfg.handleGetAllBooks)
	mux.HandleFunc("GET /{id}", cfg.handleGetBook)
	mux.HandleFunc("POST /", cfg.handleCreateBook)
	mux.HandleFunc("DELETE /{id}", cfg.handleDeleteBook)
